...
4a.Don't provide methods that modify the mutable objects.
4b. Don't share references to the mutable objects. Never store references to external, mutable objects 
...
and has no place in an immutable version of the class. The second one, invert, can be adapted by having 
